...
test("Excel exports persisted amounts and exact totals without recalculating from inputs", async () => {
  ...
  const row = { costDetailId: 42, costDescription: "Saved cost", costTypeId: 1, costId: 2, noOfUnits: 3, frequencyMonths: 2, unitPrice: "19.99", percentageCharging: "25.000", amountLocalCurrency: "0.001", amountReportingCurrency: "99999999999999999.999", amountGBP: "0.000", amountEuro: "0.002" };
  ...
  expect(rows.find((values) => values[1] === "Saved cost").slice(4)).toEqual([3, 2, 19.99, 25, 0.001, "99999999999999999.999", 0, 0.002]);

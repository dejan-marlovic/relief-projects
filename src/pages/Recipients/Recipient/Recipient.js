...
const RecipientRow = ({
  ...
  onDelete,
  poOptions = [],
  orgOptions = [], // project-aware organization options
  visibleCols = [],
  isEven = false,
}) => {
  ...
  return (
    ...
    >
      ...
      {/* 1: Organization (project-aware dropdown; fall back to numeric if empty) */}
      <Cell className={hc(1)}>
        {isEditing
          ? orgOptions.length > 0
            ? selectOrg
      ...
      {/* 2: Payment Order (dropdown filtered by project) */}
      <Cell className={hc(2)}>
